...
.config(function ($stateProvider, $urlRouterProvider) {
    ...
    .state('app.charactersCollection', {
        url: '/charactersCollection',
        views: {
            'menuContent': {
                templateUrl: 'templates/charactersCollection.html',
                controller: 'CharactersCtrl'
            }
        }
    })
...
angular.module('marvelous.controllers', ['ngCordova', 'marvelous.services'])
.controller('AppCtrl', function ($scope, $rootScope, $ionicModal, $timeout) {
    ...
    function initializeStore() {
        ...
        //Testing IAPs
        if (store.inappbilling && store.inappbilling.setTestMode) {
            store.inappbilling.setTestMode();
        }
